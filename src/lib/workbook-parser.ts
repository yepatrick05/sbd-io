...
export async function parseWorkbook(fileName: string, workbookData: Buffer): Promise<WorkbookPreview> {
    const workbook = new ExcelJS.Workbook();
    const workbookArrayBuffer = Uint8Array.from(workbookData).buffer;
